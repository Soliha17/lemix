...
import tableImg from 'src/assets/images/table__opp-exam.png';

const OpportunityCardExam = () => {
  const { t } = useTranslation();

  return (
    <div className="flex w-full flex-col-reverse items-center gap-10 rounded-3xl bg-success-12 p-6 sm:p-9 md:flex-row xl:p-16">
...
export default OpportunityCardExam;
